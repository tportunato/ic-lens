...
export default function ICLens() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F5F1", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      {/* Header */}
      <header style={{ background: "#0F2744", borderBottom: "0.5px solid #1a3557", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "56px", flexShrink: 0, position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            <span style={{ fontSize: "14px", fontWeight: 600, color: "#ffffff", fontFamily: "'DM Sans', sans-serif", letterSpacing: "0" }}>IC Lens</span>
            <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#C8692A", flexShrink: 0 }} />
          </div>
          <span style={{ fontSize: "10px", fontWeight: 600, letterSpacing: "0.09em", color: "rgba(255,255,255,0.4)", textTransform: "uppercase" }}>PE Deal Intelligence</span>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0" }}>
          {[[1, "Deal Intake"], [2, "Comparison"], [3, "AI Synthesis"]].map(([step, label], i) => (
            <div key={step} style={{ display: "flex", alignItems: "center" }}>
              <div onClick={() => setScreen(step)} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "6px 14px", cursor: "pointer", opacity: screen === step ? 1 : 0.5 }}>
                <div style={{ width: "20px", height: "20px", borderRadius: "50%", background: screen === step ? "#C8692A" : screen > step ? "#1a6b3a" : "rgba(255,255,255,0.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "10px", fontWeight: 600, color: "#fff" }}>
                  {screen > step ? "✓" : step}
                </div>
                <span style={{ fontSize: "13px", fontWeight: screen === step ? 500 : 400, color: screen === step ? "#ffffff" : "rgba(255,255,255,0.65)" }}>{label}</span>
              </div>
              {i < 2 && <div style={{ width: "20px", height: "0.5px", background: "rgba(255,255,255,0.2)" }} />}
            </div>
          ))}
        </div>
      ...
      {screen === 1 && (
        <div style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 56px)" }}>
          ...
          <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
            <div style={{ fontSize: "10px", color: "#888888", background: "#F7F5F1", border: "0.5px solid #E8E5DE", borderRadius: "8px", padding: "4px 10px" }}>
              PDF / CIM extraction — coming soon
            </div>
